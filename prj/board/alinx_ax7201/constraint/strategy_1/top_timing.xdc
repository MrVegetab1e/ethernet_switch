...
##############pll clock setting###########################
set_false_path -reset_path -from [get_clocks -of_objects [get_pins pll/inst/mmcm_adv_inst/CLKOUT0]] -to [get_clocks [list GMII_RX_CLK_0 GMII_RX_CLK_1 GMII_RX_CLK_2 GMII_RX_CLK_3 MII_TX_CLK_0 MII_TX_CLK_1 MII_TX_CLK_2 MII_TX_CLK_3 [get_clocks -of_objects [get_pins pll/inst/mmcm_adv_inst/CLKOUT1]]]]

set_false_path -from [get_clocks -of_objects [get_pins pll/inst/mmcm_adv_inst/CLKOUT1]] -to [get_clocks {MII_TX_CLK_0 MII_TX_CLK_1 MII_TX_CLK_2 MII_TX_CLK_3}]

set_false_path -from [get_clocks {MII_TX_CLK_0 MII_TX_CLK_1 MII_TX_CLK_2 MII_TX_CLK_3}] -to [get_clocks -of_objects [get_pins pll/inst/mmcm_adv_inst/CLKOUT1]]
...
create_generated_clock -name MDC_0 -source [get_ports sys_clk_p] -divide_by 400 [get_ports MDC_0]

create_generated_clock -name MDC_1 -source [get_ports sys_clk_p] -divide_by 400 [get_ports MDC_1]

create_generated_clock -name MDC_2 -source [get_ports sys_clk_p] -divide_by 400 [get_ports MDC_2]

create_generated_clock -name MDC_3 -source [get_ports sys_clk_p] -divide_by 400 [get_ports MDC_3]